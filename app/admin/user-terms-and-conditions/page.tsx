  ...
  return (
    <AdminAuthenticatedLayout>
      ...
      >
        ...
        <Paragraph>
          I, the undersigned, understands that participation in any fitness
          class, physical training, or related activity at Supra8 Lagree
          involves inherent risks. These risks include, but are not limited to,
          slips or falls; improper use or failure of equipment; overexertion;
          strains, sprains, or other physical injuries; and, in rare cases,
          serious injury or death.{" "}
        </Paragraph>
        <Paragraph>
          I acknowledge that these risks may result from my own actions, the
          actions or negligence of others, or the condition of the facilities
          and equipment. I willingly accept and assume all such risks associated
          with my participation. I further confirm that I am in good physical
          condition and have no health condition, impairment, or injury that
          would endanger myself or others during participation.
        </Paragraph>
        <Text underline>Release of Liability</Text>
        <Paragraph>
          In consideration of being allowed to participate in any class,
          training, or activity offered by Supra8 Lagree, I hereby release,
          waive, and discharge Supra8 Lagree, its owners, partners, instructors,
          staff, agents, and representatives from any and all claims,
          ...
          participating in, or as a result of participation in, any Supra8
          Lagree activity or use of its facilities or equipment.{" "}
        </Paragraph>{" "}
        <Paragraph>
          {" "}
        ...
        <Paragraph>
          ...
          permission to any Supra8 Lagree staff member to administer first aid
          as deemed necessary, and to seek medical or surgical care, including
        ...
        <Paragraph>
          ...
          owners, instructors, employees, and agents from and against any and
          all claims, damages, costs, and expenses (including attorney&apos;s
          fees) arising from my participation in Supra8 Lagree activities or
        ...
        <Paragraph>
          ...
          membership will be used solely for purposes related to class
          scheduling, account management, and communication regarding Supra8
          Lagree updates, promotions, or policy changes. Your information will
          not be shared with any third party without your consent, unless
          required by law.{" "}
        </Paragraph>
        <Paragraph>
          {" "}
          By signing this agreement or registering for any Supra8 Lagree
          service, you consent to the collection and processing of your personal
          data as described above.{" "}
        </Paragraph>{" "}
        <Paragraph>
          {" "}
          You also grant Supra8 Lagree permission to take photos or videos
          during classes or events for documentation and promotional purposes on
          the studio&apos;s official website or social media platforms. However,
          the studio will always seek explicit consent before featuring any
